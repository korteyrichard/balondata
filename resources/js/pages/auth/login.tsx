                ...
                <div className="bg-card rounded-lg shadow-2xl p-8 border border-border">
                    <div className="flex flex-col items-center mb-8">
                        <div className="bg-primary p-4 rounded-lg mb-6">
                            <img src='/balondata.jpeg' alt="BalonData" className="w-40 h-20" />
                        </div>
                    </div>
                        ...
                        <div>
                            <div className="relative">
                                <Input
                                    ...
                                    required
                                    className="w-full px-4 py-3 pr-10 border border-border rounded-md focus:outline-none focus:ring-2 focus:ring-ring"
                                />
                                <button
                                    type="button"
                    ...
                    <div className="mt-6 text-center space-y-2">
                        <div className="text-sm text-foreground">
                            New to our site? <Link href={route('register')} className="text-primary hover:underline font-medium">Signup</Link>
                        </div>
                        <div className="text-sm">
                            <Link href={route('password.request')} className="text-primary hover:underline font-medium">Forgot password?</Link>
